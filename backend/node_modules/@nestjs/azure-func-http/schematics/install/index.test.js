...
describe('Schematic Tests Nest Add', () => {
    ...
    describe('Tests for monorepo', () => {
        it('should add azure-func for monorepo app', async () => {
            ...
            await runner.runExternalSchematic('@nestjs/schematics', 'sub-app', {
                name: projectName
            }, nestTree);
            const tree = await runner.runSchematic('nest-add', options, nestTree);
            const files = tree.files;
    ...
    async function createTestNest(runner, tree) {
        return await runner.runExternalSchematic('@nestjs/schematics', 'application', {
            name: 'newproject',
            directory: '.'
        }, tree);
    }
